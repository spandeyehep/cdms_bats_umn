...
export BATROOT_NOISEFILES=$_CONDOR_SCRATCH_DIR/br_output
...
$BATROOTDIR/noise/NoiseGen $1 $2 $3 processingSoudanData.$5Grid.$4 >& $_CONDOR_SCRATCH_DIR/br_output/$1.brnoiselog
...
mkdir -p -m 775 /grid/data/cdms/processing/noise_files/$5/ROOT
/bin/cp -f $_CONDOR_SCRATCH_DIR/br_output/*_Filter_$1.root /grid/data/cdms/processing/noise_files/$5/ROOT/.

#move log file back to storage
mkdir -p -m 775 /grid/data/cdms/processing/br_logs/$1/
/bin/cp -f $_CONDOR_SCRATCH_DIR/br_output/$1.brnoiselog /grid/data/cdms/processing/br_logs/$1/.

#cleanup - no needed to with $_CONDOR_SCRATCH_DIR, but just in case
/bin/rm -f $_CONDOR_SCRATCH_DIR/br_input/$1_$DUMPID.gz
/bin/rm -f $_CONDOR_SCRATCH_DIR/br_output/*_Filter_$1.root
/bin/rm -f $_CONDOR_SCRATCH_DIR/br_output/$1.brnoiselog
