...
void zipRQOverlay(string brRQ, string dpRQ, string filename="170319_1616_F0006", int dumpNum=6, int notCharge=0)
{
	       ...
	       string brRQ, string dpRQ, string filename, int dumpNum)
{
   ...
   //DarkPipe file
   TFile f_dp("../testOutput/170319_1616_RRQ_even.root");
