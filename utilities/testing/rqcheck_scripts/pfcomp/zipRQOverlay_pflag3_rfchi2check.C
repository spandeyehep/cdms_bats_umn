...
void zipRQOverlay_pflag3_rfchi2check(string brRQ, string brRQ2, string pfRQ, string brPulseFlag, string pfPulseFlag, string rfeflag,string filename="170319_1616_F0006", int dumpNum=6, int notCharge=0)
{
	       ...
	       string brRQ, string brRQ2, string pfRQ, string filename, int dumpNum, string brPulseFlag, string pfPulseFlag, string rfeflag)
{
   ...
   TString brweight = Form("(%s%s == 3 && %s%s == 0)*(%s%s/%s%s)", chanUp.c_str(), brPulseFlag.c_str(), chanUp.c_str(), rfeflag.c_str(),chanUp.c_str(),brRQ.c_str(),chanUp.c_str(),brRQ2.c_str());
