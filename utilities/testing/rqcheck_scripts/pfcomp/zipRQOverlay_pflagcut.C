...
void zipRQOverlay_pflagcut(string brRQ, string prRQ, string filename="170319_1616_F0006", int dumpNum=6, int notCharge=0)
{
	       ...
	       string brRQ, string prRQ, string filename, int dumpNum)
{
   ...
   //Make histograms
   TString brweight = Form("(%sPFfpflag == 1 || %sPFfpflag == 2)*%s%s", chanUp.c_str(), chanUp.c_str(), chanUp.c_str(), brRQ.c_str());
