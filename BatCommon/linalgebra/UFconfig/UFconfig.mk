...
# the ONLY modification for CDMSBATS subpackage making
ifndef CDMS_MAKEFILES
CDMS_MAKEFILES := ../../../makefiles/
endif
#not guaronteed this directory exists if making from this dir?
ifndef TOPLEVELPKG
TOPLEVELPKG := linalgebra
endif

#INSTALL_INCLUDE = $(BUILDDIR)include
#so this package copies to local BUILD version
INSTALL_LIB = ../../LIB/$(TOPLEVELPKG)/
ifndef CDMS_CAP_MAKE
BUILDDIR := $(CDMS_MAKEFILES)../BUILD/$(TOPLEVELPKG)/
INSTALL_LIB = $(BUILDDIR)lib
endif
INSTALL_INCLUDE = ../BUILD/include
