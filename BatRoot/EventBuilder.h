...
class EventBuilder 
{
   public:
      ...
      EventBuilder(UserDataManager& myUserData, DetectorConfigManager& myDetectorConfigManager, 
		   string& inputRawDataFile);  

      ~EventBuilder(); //destructor
	...
	fDatabaseIsRegistered = true;
      ...
      void FillNoiseMonitorPulseCollection(vector<PulseData>& pulseCollection) const;
      ...
      int      GetNNoiseMonitorPulses() const { return fVectorOfNoiseMonitorPulses.size(); }
      ...
      void ReadSimEvent();
      void SetPulseLibManager(vector<string> input_filename);
      
      //Veto
      void DoVetoAnalysis();
      
      //NoiseMonitor
      void DoNoiseMonitorAnalysis();
      ...
      void DoDatabasePulseCalc(int detNum);
	  ...
	  void DoOptimalFilterPhonon1X2(int detNum, const string& sensorType);
	  void DoOptimalFilterPhononDMC(int detNum, const string& sensorType);
      ...
      void DoSimulateFromPulse(int detNum, vector<string> filename, int thEvt);
   ...
   private:
      ...
      vector<PulseData> fVectorOfNoiseMonitorPulses;
